...
import sacrebleu
import re
import nltk.translate.chrf_score as  nt
...
if __name__ == '__main__':
    ...
    with open(args.in_reference_tokens,'r',encoding = 'UTF-8') as f:
          gold=f.readlines()
    
    with open(args.in_tokens,'r',encoding = 'UTF-8') as f:
          pred=f.readlines()
    
    chrfs=nt.corpus_chrf(gold, pred)* 100

    print('chrF++ {:.2f}'.format(chrfs))