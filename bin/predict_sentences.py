...
from modules.evaluation import predict_amrs, compute_smatch, predict_sentences, compute_bleu
from modules.penman import encode
from modules.utils import instantiate_loader, instantiate_model_and_tokenizer
...
if __name__ == '__main__':
    ...
    loader = instantiate_loader(
        ...
        evaluation=True, out='data/tmp/a.txt',
